...
Electronics engineer by training but software engineer by trade, with 10+ years experience developing software and 9+ years in the robotics scene. Fascinated by perception, actuation, and decision making problems in robotics.
...
\begin{minipage}{0.55\linewidth}
  \begin{description}
    \item[System Programming] C++14/17/20, Python 3.x, Rust, C99/11.
    \item[Robotics \& Simulation] ROS 2, OpenCV, GTSAM, Gazebo, Drake.
    \item[Scientific Computing] Eigen, SciPy, NumPy, R, Matlab.
...
\begin{minipage}{0.4\linewidth}
  \begin{description}
    ...
    \item[Bilingual] English (C2), Spanish (native).
  \end{description}
\end{minipage}
\hfill
...
\begin{itemize}
  \item Leading R\&D division through projects on localization and mapping, nonlinear control, machine learning, and more.
  ...
  \item Worked on a ROS 2-powered AMR prototype and ROS-powered AUVs for oceanographic research, on multiple fronts such as IMU/GPS sensor integration, EKF-based localization, Graph SLAM-based mapping, and simulation using Gazebo.
  ...
  \item Elected as representative in the OSRA TGC for the silver members' tier, twice.
\end{itemize}
...
\noindent\begin{minipage}[t]{0.475\linewidth}
  ...
  \subsection*[\icon{erf}]{European Robotics Forum 2024}
  \begin{itemize}
    \item Co-author and speaker for \href{https://link.springer.com/chapter/10.1007/978-3-031-76424-0_23}{Beluga: a Modern Monte Carlo Localization Package for ROS and ROS 2}.
  \end{itemize}
  \subsection*[\icon{upenn}]{UPenn Spring 2024 GRASP SFI}
  \begin{itemize}
    \item Seminar on \href{https://www.grasp.upenn.edu/events/spring-2024-grasp-sfi-michel-hidalgo}{Doing robotics in digital labs: Or how simulations fuel robotics development}.
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item Co-author and speaker of \href{https://roscon.ros.org/2019/talks/roscon2019_markupextensionsforros2launch.pdf}{Markup Descriptions in ROS 2 Launch}.
  \end{itemize}
\end{minipage}\hfill
\begin{minipage}[t]{0.475\linewidth}
  ...
  \begin{description}
    ...
    \item[\githubproject{lambkin}{Ekumen-OS/lambkin}] (S)LAM benchmarking (contributor).

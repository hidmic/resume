...
\begin{itemize}
  ...
  \item Worked on a ROS 2-powered AGV prototype and ROS-powered AUVs for oceanographic research, on multiple fronts such as IMU/GPS sensor integration, EKF-based localization, Graph SLAM-based mapping, and simulation using Gazebo and Ignition.
...
\begin{itemize}
  ...
  \item Worked on ROS-powered AGVs for the hospitality industry and for retail inventory management, on multiple fronts such as EKF + AMCL-based localization, navigation using DWA and potential fields, simulation using Gazebo, and deployment via debians.
\end{itemize}

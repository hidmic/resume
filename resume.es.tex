...
Ingeniero en Electrónica por formación pero ingeniero en Informática de profesión, con más de 10 años de experiencia desarrollando software y más de 9 años enfocado en la robótica. Fascinado por los mecanismos de percepción, actuación y toma de decisión en robótica.
...
\begin{minipage}{0.55\linewidth}
  \begin{description}
    \item[Programación] C++11/14/17, Python 3.x, Rust, C99/11.
    \item[Robótica y Simulación] ROS 2, OpenCV, GTSAM, Drake, Gazebo.
    \item[Cómputo científico] Eigen, SciPy, NumPy, R, Matlab.
...
\begin{minipage}{0.4\linewidth}
  \begin{description}
    ...
    \item[Bilingüe] Inglés (C2), Español (nativo).
  \end{description}
\end{minipage}
\hfill
...
\begin{itemize}
  ...
  \item Postulé y actué como representante en el OSRA TGC para los miembros silver, dos veces.
\end{itemize}
...
\noindent\begin{minipage}[t]{0.475\linewidth}
  ...
  \begin{itemize}
      \item Charla sobre \href{https://link.springer.com/chapter/10.1007/978-3-031-76424-0_23}{Beluga: a Modern Monte Carlo Localization Package for ROS and ROS 2}
  \end{itemize}
  \subsection*[\icon{upenn}]{UPenn Spring 2024 GRASP SFI}
  \begin{itemize}
    \item Seminario sobre \href{https://www.grasp.upenn.edu/events/spring-2024-grasp-sfi-michel-hidalgo}{Doing robotics in digital labs: Or how simulations fuel robotics development}.
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item Charla sobre \href{https://roscon.ros.org/2019/talks/roscon2019_markupextensionsforros2launch.pdf}{Markup Descriptions in ROS 2 Launch}
  \end{itemize}
\end{minipage}\hfill
\begin{minipage}[t]{0.475\linewidth}
  ...
  \begin{description}
    ...
    \item[\githubproject{lambkin}{Ekumen-OS/lambkin}] Benchmarks para sistemas de (S)LAM.
